# Ditherloom Suite Home Assistant Add On License

Project license: Polycom 1.

Copyright (c) Neil Cameron.

The Ditherloom Suite Home Assistant Add On source code, Ditherloom-specific
renderer rules, card layouts, palette-safe graphic compositions, custom
four-colour device-screen imagery, documentation, and project-specific assets
