...
class DitherloomFrameScheduleSensor(DitherloomSensorBase):
    ...
    def extra_state_attributes(self):
        ...
        return {
            ...
            "frame_awake_last_completion_command": metadata.get("frame_awake_last_completion_command"),
            "frame_awake_last_completion_sent_at": metadata.get("frame_awake_last_completion_sent_at"),
            "frame_awake_last_completion_response": metadata.get("frame_awake_last_completion_response"),
            "frame_awake_last_completion_ok": metadata.get("frame_awake_last_completion_ok"),
            "frame_sleeping_expected_after_completion": metadata.get("frame_sleeping_expected_after_completion"),
